...
<div class="container" style="margin-top:100px;">
  <div class="row justify-content-center" >
        <div class="col-md-8" >
         <h3 style="text-align: center;">Ajoutez le(s) participant(s) du troisième superviseur</h3>
            <div class="card" >
          
            <form method="post" action="{{url('participants/store?value3='.$participants3.'&value4='.$participants4.'&value5='.$participants5.'&superviseurid3='.$superviseurid3.'&superviseurid4='.$superviseurid4.'&superviseurid5='.$superviseurid5.'&projet_id='.$projet_id)}}" enctype="multipart/form-data">
{{ csrf_field() }}
@for($i=1; $i<$participants3 + 1; $i++)
